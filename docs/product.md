...
- **Visual mode** — Render charwise/linewise/blockwise visual selection in the TUI; Ctrl+C acts like Esc via the `<C-c> → <Esc>` keymap mapping; `:q` is the quit command ([story](stories/006-ctrl-c-exit-visual-mode/story.md))
