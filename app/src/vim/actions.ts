...
export const actions: Record<string, ActionFunc> = {
  ...
  scrollToCursor: (adapter, actionArgs) => {
  ...
  replayMacro: (adapter, actionArgs, vim) => {
  ...
  enterMacroRecordMode: (adapter, actionArgs) => {
    const macroModeState = vimGlobalState.macroModeState
  ...
  enterInsertMode: (adapter, actionArgs, vim) => {
  ...
  reselectLastSelection: (adapter, _actionArgs, vim) => {
  ...
  joinLines: (adapter, actionArgs, vim) => {
    let curStart: Pos
    let curEnd: Pos
    if (vim.visualMode) {
  ...
  setMark: (adapter, actionArgs, vim) => {
  ...
  incrementNumberToken: (adapter, actionArgs) => {
  ...
  repeatLastEdit: (adapter, actionArgs, vim) => {
